...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Every bet shapes the global pool. Play solo and multiplayer games in a neon casino built on the community economy." },
      { property: "og:title", content: "PoolCasino — Play against the Global Economy" },
      { property: "og:description", content: "Every bet shapes the global pool. Play solo and multiplayer games in a neon casino built on the community economy." },
      ...
      <div className="space-y-12">
        ...
        <section className="space-y-6">
          <div className="flex items-end justify-between">
            ...
            <Link to="/games" className="text-sm font-medium text-primary hover:text-primary/80 flex items-center gap-1 transition-colors">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {FEATURED.map((game) => (
              <Link key={game.to} to={game.to} className="group block">
                <Card className={`h-full overflow-hidden transition-all duration-500 hover:scale-[1.02] border-white/5 relative ${game.hoverClass}`}>
                  ...
                  <CardContent className="p-0 flex flex-col sm:flex-row h-full">
                    <div className="p-7 flex-1 flex flex-col justify-center space-y-3">
                      ...
                      <h3 className={`text-xl font-display font-bold transition-colors duration-300 ${game.btnClass}`}>
                        {game.name}
                      </h3>
