...
export const allGames = [
  { id: "roulette", name: "Neon Roulette", description: "Classic red or black with dynamic odds based on the global pool.", image: rouletteImg, to: "/games/roulette", accentClass: "group-hover:border-primary/50 group-hover:shadow-[0_0_30px_rgba(0,255,170,0.2)]", titleClass: "group-hover:text-primary", tag: "Classic", tagColor: "bg-primary/20 text-primary" },
...
export const Route = createFileRoute("/games/")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Browse 32 solo casino games and bet against the global pool." },
