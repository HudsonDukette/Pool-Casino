...
function AdminPanel() {
  ...
  const mInitFake = useMutation({ mutationFn: useServerFn(initializeFakePlayersSystem), onSuccess: (data) => { toast({ title: "Fake players initialized", description: `Target: ${data.targetCount}, Created: ${data.created}` }); invalidate(); }, onError });
