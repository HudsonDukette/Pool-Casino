...
export default function Countdown() {
  ...
  return (
    <GameShell title="Countdown Gamble" description="10 seconds on the clock — more time left means a higher multiplier. Cash out at the right moment!" accentColor="text-blue-400">
