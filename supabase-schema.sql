...
ALTER TABLE "friends" ADD CONSTRAINT "friends_recipient_id_users_id_fk" FOREIGN KEY ("recipient_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "money_requests" ADD CONSTRAINT "money_requests_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "ban_appeals" ADD CONSTRAINT "ban_appeals_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "match_rounds" ADD CONSTRAINT "match_rounds_match_id_matches_id_fk" FOREIGN KEY ("match_id") REFERENCES "public"."matches"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "match_rounds" ADD CONSTRAINT "match_rounds_winner_id_users_id_fk" FOREIGN KEY ("winner_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
...
ALTER TABLE "multiplayer_queue" ADD CONSTRAINT "multiplayer_queue_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "user_monthly_progress" ADD CONSTRAINT "user_monthly_progress_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "user_monthly_progress" ADD CONSTRAINT "user_monthly_progress_challenge_id_monthly_challenges_id_fk" FOREIGN KEY ("challenge_id") REFERENCES "public"."monthly_challenges"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "casino_bets" ADD CONSTRAINT "casino_bets_casino_id_casinos_id_fk" FOREIGN KEY ("casino_id") REFERENCES "public"."casinos"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "casino_bets" ADD CONSTRAINT "casino_bets_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "casino_drinks" ADD CONSTRAINT "casino_drinks_casino_id_casinos_id_fk" FOREIGN KEY ("casino_id") REFERENCES "public"."casinos"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "casino_game_odds" ADD CONSTRAINT "casino_game_odds_casino_id_casinos_id_fk" FOREIGN KEY ("casino_id") REFERENCES "public"."casinos"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "casino_games_owned" ADD CONSTRAINT "casino_games_owned_casino_id_casinos_id_fk" FOREIGN KEY ("casino_id") REFERENCES "public"."casinos"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "casino_transactions" ADD CONSTRAINT "casino_transactions_casino_id_casinos_id_fk" FOREIGN KEY ("casino_id") REFERENCES "public"."casinos"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "casinos" ADD CONSTRAINT "casinos_owner_id_users_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "casinos" ADD CONSTRAINT "casinos_insolvency_winner_id_users_id_fk" FOREIGN KEY ("insolvency_winner_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "monthly_tax_logs" ADD CONSTRAINT "monthly_tax_logs_casino_id_casinos_id_fk" FOREIGN KEY ("casino_id") REFERENCES "public"."casinos"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "user_drinks" ADD CONSTRAINT "user_drinks_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "user_drinks" ADD CONSTRAINT "user_drinks_casino_id_casinos_id_fk" FOREIGN KEY ("casino_id") REFERENCES "public"."casinos"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "user_drinks" ADD CONSTRAINT "user_drinks_drink_id_casino_drinks_id_fk" FOREIGN KEY ("drink_id") REFERENCES "public"."casino_drinks"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "money_ledger" ADD CONSTRAINT "money_ledger_actor_user_id_users_id_fk" FOREIGN KEY ("actor_user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
